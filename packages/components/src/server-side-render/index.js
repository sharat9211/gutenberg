...
export class ServerSideRender extends Component {
	...
	render() {
		...
		if ( ! response ) {
			return (
				<Placeholder className={ className }><Spinner /></Placeholder>
			);
			...
			return (
				<Placeholder className={ className }>{ __( 'No results found.' ) }</Placeholder>
			);
		}

		return (
			<RawHTML key="html" className={ className }>{ response }</RawHTML>
		);
	}
}
